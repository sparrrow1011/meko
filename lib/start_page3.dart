...
class StartPagethree extends StatefulWidget {
  const StartPagethree({Key? key}) : super(key: key);

  @override
  _StartPagethreeState createState() => _StartPagethreeState();
}

class _StartPagethreeState extends State<StartPagethree> {
  @override
                ...
                children: [
                  ...
                  Column(
                    children: [
                      ...
                      Text(
                        'Relax until your car is done or get a sponsored ride to your destination.',
