...
displaySnackbar(scaffoldkey, content, background){
  scaffoldkey.currentState
      .showSnackBar(SnackBar(content: Text(content), backgroundColor: background, elevation: 1000, behavior: SnackBarBehavior.floating,));
}
...
Widget completeDialog(BuildContext context, String text, {String subtext:'', onClose}) {
  return new AlertDialog(contentPadding: EdgeInsets.all(40),
